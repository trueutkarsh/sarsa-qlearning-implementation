...
parser.add_argument('-gamma', '--gamma', dest='gamma', type=float, default=0.9, help='Discount Factor')
parser.add_argument('-lambda', '--lambda', dest='lamb', type=float, default=0.9, help='Value of lambda')
...
parser.add_argument('-a', '--alpha', dest='alpha', type=float, default=0.5, help='Alpha')
...
try:
    ...
    agent = Agent(numStates, state, args.gamma, args.lamb, args.algorithm.lower() + " " + args.trace.lower(), args.randomseed, args.alpha) 
